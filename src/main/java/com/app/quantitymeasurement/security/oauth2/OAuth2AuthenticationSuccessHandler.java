...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        // We will pass the username, email, and id too to mock the /signin JWT response
        // locally if needed.
        // Easiest is to just pass token, username, email in URL query parameters so
        // frontend can construct standard localStorage "user" object.
